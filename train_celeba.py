...
# face_dataset = CreateDataLoader(opt, csv_fileA='./dataset/raw_images/CelebA_Anno/list_attr_celeba.txt',root_dirA='./dataset/raw_images/train/images',
#                                      csv_fileB='./dataset/raw_images/CelebA_Anno/list_attr_celeba.txt', root_dirB='./dataset/raw_images/train/images')
face_dataset = CreateDataLoader(opt, csv_fileA='./dataset/raw_images/CelebA_Anno/list_attr_celeba.txt',root_dirA='./dataset/CelebA/Img/img_align_celeba',
                                     csv_fileB='./dataset/raw_images/CelebA_Anno/list_attr_celeba.txt', root_dirB='./dataset/CelebA/Img/img_align_celeba')
...
for epoch in range(1, opt.niter + opt.niter_decay + 1):
    ...
    batch_idx = np.array(range(np.int(train_num/opt.batchSize)))
    shuffle(batch_idx)
